...
1. owlControl: a PCB with an integrated **Raspberry Pico (RP2040)** with sockets for I2C, GPIO etc. and an integrated **CAN bus** interface. Optionally, it contains a breakout for a **Raspberry PI** (the 'brain'). The Raspberry, the Pico and your own hardware can use the CAN bus for communication.
