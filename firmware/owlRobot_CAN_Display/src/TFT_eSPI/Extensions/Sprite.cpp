// Ensure the core class is visible when compiling this extension
#include "../TFT_eSPI.h"

#ifndef TFT_ESPI_SOURCE
// Intentionally empty to avoid standalone compilation as a separate TU
#else

// Define the same clipping macro used in the core, local to this TU
#ifndef PI_CLIP
#define PI_CLIP                                        \
  if (_vpOoB) return;                                  \
  x+= _xDatum;                                         \
